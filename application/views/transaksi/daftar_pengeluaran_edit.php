...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="<?= base_url('transaksi/daftarPengeluaran') ?>"><i class="fa fa-exchange"></i>Transaksi Pengeluaran</a></li>
			...
			<div class="col-md-6">
				<div class="box box-primary">
					...
					<div class="card box-primary">
						<!-- form start -->
						<div class="box-body">
							<form action="<?= base_url('transaksi/editPengeluaran/'.$pengeluaran['NO_KELUARAN']) ?>" method="post">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="alasan" id="alasan"><?= $pengeluaran['ALASAN'] ?></textarea>
								...
								<div class="form-group">
									...
									<input type="number" name="biaya"  id ="biaya" class="form-control" value="<?= $pengeluaran['BIAYA'] ?>">
