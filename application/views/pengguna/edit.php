...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-database"></i>Pengguna</a></li>
			...
			<div class="col-md-6">
				<div class="box box-primary">
					...
					<div class="card box-primary">
						<!-- form start -->
						<div class="box-body">
							<form action="<?= base_url('pengguna/edit/'.$pengguna->ID_USER) ?>" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<select name='role_id' class='form-control'>
										...
										<?php foreach ($role as $item) { ?>
											<option value="<?= $item->ROLE_ID ?>" <?= $item->ROLE_ID == $pengguna->ROLE_ID ? 'selected=selected' : '' ?>><?= $item->ROLE ?></option>
										<?php } ?>
									</select>
									<div class="input-group">
